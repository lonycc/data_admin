...
<head>
    ...
    <meta property="og:title" content="Oauth2 demo">
    <meta property="og:url" content="http://oauth2/">
    <meta property="og:site_name" content="Oauth2 demo">
    <meta property="og:description" content="As we do,as you know.">
    <meta name="twitter:title" content="Oauth2 demo">
    ...
    <div class="col-md-8">
        ...
        <form class="form-inline">
            ...
            <div class="form-group">
                <label for="Credentials"><h3>第一种：用户口令（Resource Owner Password Credentials）:</h3><br><h4>适用于给自己的应用提供api</h4><br>
            ...
            <div class="form-group">
                <label for="authorize">
                    ...
                    <div>code参数 请通过`<a target="_blank" href="/authorize?response_type=code&client_id=testclient&redirect_uri=http://php/&state=xyz&scope=">/oauth2/authorize?response_type=code&client_id=testclient&redirect_uri=http://php/&state=xxx&scope=</a>`跳转后取得。</div><br>
                </label><br>
...
$(document).ready(function(){
    ...
    $('#btn-authorize').click(function (e){
        var data = {code: $("#authorize-code").val(), client_id: 'testclient', client_secret:'testpass', redirect_uri:"http://php/", grant_type: 'authorization_code', scope:'userinfo'};
