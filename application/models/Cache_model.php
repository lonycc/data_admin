...
class Cache_model extends CI_Model
{
    ...
    {
        if ( ! file_exists(APPPATH . 'settings/' . $folder) )
            @mkdir(APPPATH . 'settings/' . $folder);
    }
	...
	public function update_model_cache($target = '')
	{
		...
		foreach ($models as $model) {
			...
			$this->platform->cache_write(APPPATH . 'settings/model/'.$model['name'].'.php',
	...
	public function update_category_cache($target = '')
	{
		...
		foreach ($models as $model) {
			...
			$this->platform->cache_write(APPPATH . 'settings/category/cate_' . $model['name'] . '.php',
			...
			$this->platform->cache_write(APPPATH . 'settings/category/data_' . $model['name'] . '.php',
	...
	public function update_menu_cache()
	{
		...
		$this->platform->cache_write(APPPATH . 'settings/menus.php',
	...
	public function update_role_cache($target = '')
	{
		...
		foreach ($roles as & $role) {
			...
			$this->platform->cache_write(APPPATH . 'settings/acl/role_' . $role['id'] . '.php',
	...
	public function update_site_cache()
	{
		...
		$this->platform->cache_write(APPPATH . 'settings/site.php',
	...
	public function update_backend_cache()
	{
		...
		$this->platform->cache_write(APPPATH . 'settings/backend.php',
									 array_to_cache("setting", $data));
	}
	...
	public function update_plugin_cache()
	{
		...
		$this->platform->cache_write(APPPATH . 'settings/plugins.php',
