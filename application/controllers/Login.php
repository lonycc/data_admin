...
class Login extends CI_Controller {
    ...
    protected function code() {
        ...
        $vals = array("word" => "", "img_path" => dirname(BASEPATH) . "/static/captcha/", "img_url" => base_url('static/captcha'), "img_width" => 100, "img_height" => 42, "expiration" => 20, "word_length" => 5, "colors" => array("background" => array(255, 255, 255), "border" => array(255, 255, 255), "text" => array(0, 0, 0), "grid" => array(255, 40, 40)));
