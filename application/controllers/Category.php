...
class Category extends MY_Controller {
    ...
    public function view() {
        ...
        $data['bread'] = make_bread(Array('分类模型管理' => '',));
    ...
    public function _add_post() {
        if ($this->_validate_model_form() == TRUE) {
            ...
            $data['bread'] = make_bread(Array('分类模型管理' => site_url('/category/view'), '添加分类模型' => '',));
    ...
    public function _edit_post($id = 0) {
        ...
        if ($this->_validate_model_form($target_model->name) == TRUE) {
            ...
            $data['bread'] = make_bread(Array('分类模型管理' => site_url('/category/view'), '编辑 :: ' . $target_model->description => '',));
    ...
    public function fields($id = 0) {
        ...
        $data['bread'] = make_bread(Array('分类模型管理' => site_url('/category/view'), $data['model']->description => '',));
    ...
    public function _add_field_post($id = 0) {
        ...
        if (!$this->_validate_field_form($id)) {
            $data['bread'] = make_bread(Array('分类模型管理' => site_url('/category/view'), $data['model']->description => site_url('/category/fields/' . $data['model']->id), '添加字段' => '',));
    ...
    public function _edit_field_post($id = 0) {
        ...
        if ($this->_validate_field_form($data['field']->model, $data['field']->name)) {
            ...
            $data['bread'] = make_bread(Array('分类模型管理' => site_url('/category/view'), $data['model']->description => site_url('/category/fields/' . $data['model']->id), '编辑字段' => '',));
