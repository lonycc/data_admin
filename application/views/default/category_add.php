        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading">新增分类模型</div>
                    ...
                    <?php echo form_open('/category/add'); ?>
                        <div class="canvas-wrapper">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="description" class="form-control" placeholder="有意义的名称，不超过40位" />
                            </div>
                            <div class="form-group">
                                <label>分类模型层级：</label><?php echo form_error('level'); ?>
                                <input type="text" name="level" class="form-control" placeholder="分类的层级" />
                            </div>
                            <div class="form-group">
                                <label>每页显示条数：</label><?php echo form_error('perpage'); ?>
                                <input type="text" name="perpage" class="form-control" placeholder="每页列表显示的条数" />
                            </div>
                            <div class="form-group">
                                ...
                                <table class="table table-striped table-hover table-bordered" id="customtable" style="display:none;">
                                    ...
                                    <tr>
                                        <td><input type="checkbox" name="thumbnail[<?php echo $pref->size; ?>]" value="1"></td>
                            ...
                            <div class="form-group">
                                ...
                                <input type="radio" name="auto_update" value="1" />是
                                <input type="radio" name="auto_update" value="0" checked />否
                            </div>
