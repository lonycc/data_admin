...
<div id="dili_uploader">
    ...
    <div style="position:relative;text-align:left;">
        ...
        <div id="uploaderContainer" style="position:absolute;z-index:3000000;display:none;background:#ccc;">
            <object id="swfuploader" type="application/x-shockwave-flash" data="/static/js/upload.swf?site=<?php echo backend_url('attachment'); ?>" width="470" height="268">
                <param name="movie" value="/static/js/upload.swf?site=<?php echo backend_url('attachment'); ?>"/>
    ...
    <script src="/static/js/contextMenu/jquery.ui.position.js"></script>
